...
def play(state, select_action, possible_actions):
    action = select_action(state)
    # print(action)
    perform_action(possible_actions, action)
    return action

def train_and_play(state, select_action, possible_actions, optimize):
    action = play(state, select_action, possible_actions)
    optimize()
    return action
